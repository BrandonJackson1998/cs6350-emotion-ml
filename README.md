...
The project includes powerful analysis tools to understand how your model evolved across experiments:

### 🔍 **Analysis Capabilities:**
- **📈 Training Progression**: Visualize loss and accuracy across experiments
- **🎯 Emotion Focus Evolution**: See how training lens changed over time
- **🔗 Checkpoint Chains**: Track how experiments connected and evolved
- **📊 Performance Comparison**: Compare final accuracies across experiments
- **📝 Comprehensive Reports**: Detailed analysis with key insights

### 🛠️ **Analysis Tools:**
- `analyze_training_progression.py` - Complete training analysis with visualizations
- `show_training_lens.py` - Emotion focus progression and heatmaps
- `show_checkpoint_chain.py` - Checkpoint chain and training flow
...
📊 Step 1: disgust_surprise_focus
   🔺 Promoted: disgust (3.0x), surprise (2.5x)
   🔻 Demoted: happy (0.3x)
   🚀 New experiment

📊 Step 2: fear_focus  
   🔺 Promoted: fear (3.0x)
   🔻 Demoted: disgust (0.3x), happy (0.5x)
   🔄 Resumed from: ./experiments/disgust_surprise_focus/checkpoint_epoch_3.pt

📈 Chain Summary:
   🔗 Total steps: 2
   🔄 Resumed experiments: 1
   🚀 New experiments: 1
```
...
**5. Analyze Training Progression:**
```bash
# Comprehensive analysis across multiple experiments
python3 scripts/analyze_training_progression.py \
    --experiments experiments/exp1 experiments/exp2 \
    --output-dir analysis --name my_analysis

# Show training lens evolution
python3 scripts/show_training_lens.py \
    --experiments experiments/exp1 experiments/exp2 \
    --output-dir analysis --name lens_analysis

# Visualize checkpoint chain
python3 scripts/show_checkpoint_chain.py \
    --experiments experiments/exp1 experiments/exp2 \
    --output-dir analysis --name chain_analysis
```
